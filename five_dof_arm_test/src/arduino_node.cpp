...
std_msgs::Float64 servo_1_1_position, servo_2_2_position,
    servo_3_1_position, servo_4_1_position, claw_position, arm_velocity;
...
void callback(const sensor_msgs::JointState &msg){
  ...
  claw_position.data = msg.position[4];
...
int main(int argc, char **argv){
  ...
  pub5 = n.advertise<std_msgs::Float64>("claw_position", 100);
